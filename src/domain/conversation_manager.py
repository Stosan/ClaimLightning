...
class ConversationManager:
    def __init__(self,query:str,policy_number:str,db_client_config:MongoDBClientConfig):
        self.query=query
    ...
    def llm_call(self)->str:
        ...
        try:
            ...
            user_prompt = user_prompt.format(query=self.query, policy_number=self.policy_number)
            messages = [
